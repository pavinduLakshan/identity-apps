...
<%
    ...
    boolean showSecretKeyInEnrollment = Boolean.parseBoolean(application.getInitParameter("ShowTOTPSecretKeyInEnrollment"));
...
<html lang="en-US">
    ...
    <body class="login-portal layout totp-portal-layout">
                        ...
                        <form class="ui large form mb-0" id="pin_form" name="pin_form" action="<%=commonauthURL%>"  method="POST">
                            ...
                            <div class="ui center aligned basic segment middle aligned" style="padding-left: 0; padding-right: 0; margin-top: 0;">
                                ...
                                <div id="totpSecretContainer" style="display:none; margin-bottom: 2rem;">
                                    <p style="text-align: center; margin-bottom: 1rem; font-size: 14px;">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: stretch;">
                                        <div class="ui action input" style="width: 100%; max-width: 100%;" action="">
                                            <input
                                                ...
                                                type="password"
                                                readonly
                                                style="font-weight: bold; font-family: monospace; letter-spacing: 3px; font-size: 14px; text-align: center; padding: 0.75rem 1rem; flex: 1;"
                                            >
                                            <button
        ...
        <script type="text/javascript">
            ...
            var showSecretKeyInEnrollment = <%= showSecretKeyInEnrollment %>;

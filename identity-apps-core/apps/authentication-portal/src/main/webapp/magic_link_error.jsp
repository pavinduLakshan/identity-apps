...
<% request.setAttribute("pageName", "magic-link-error"); %>
...
<html>
    ...
    <body class="login-portal layout" data-response-type="error" data-page="<%= request.getAttribute("pageName") %>">
            ...
            <layout:component componentName="MainSection">
                <div class="ui orange attached segment mt-3">
                    <h3 class="ui header text-center slogan-message mt-3 mb-6">
                        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "error.magic.link.title")%>
                    </h3>
                    <%

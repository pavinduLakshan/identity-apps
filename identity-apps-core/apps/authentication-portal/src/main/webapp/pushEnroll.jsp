...
<html lang="en-US">
    ...
    <body class="login-portal layout totp-portal-layout">
            ...
            <layout:component componentName="MainSection">
                <div class="ui segment attached segment-with-attached mt-3">
                    ...
                    <h3 class="ui header text-center">
                        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "register.push.device")%>
                    </h3>
                    <%
                    ...
                    <div class="segment-form">
                        <form class="ui large form mb-0" id="register_form" name="register_form" action="<%=commonauthURL%>"  method="POST">
                            <%
                                ...
                                <div id="checkboxField" class="field mb-5">
                                    <div class="ui checkbox">
                                        ...
                                        <label for="checkbox"><%=AuthenticationEndpointUtil.i18n(resourceBundle,
                                            "confirm.you.have.scanned.the.qr.code.push")%></label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="ui warning bottom attached message text-left display-flex" style="font-size: small;">
                    ...
                    <div class="message-content">
                        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "dont.have.app.download")%>
                        <a
                            href=<%=pushAppInfoLink%>
                        >
                            <%=AuthenticationEndpointUtil.i18n(resourceBundle, "dont.have.app.download.link")%>
                        </a>
                        <%=AuthenticationEndpointUtil.i18n(resourceBundle, "for.more.details.and.download.options")%>
                    </div>
                </div>
                <% } %>
        ...
        <script type="text/javascript">
            ...
            function showQR(){
                var key =  document.getElementById("pushEnrollData").value;
                if(key != null) {
                    loadQRCode(key);
                }
            }
